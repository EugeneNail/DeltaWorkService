...
export default function EditService({ userService, services }) {
    ...
    const isPicked =
        data.is_by_agreement || data.is_hourly_type || data.is_work_type;
        ...
        <>
            ...
            <Page>
                <Header className="my-12">
                    {isCreating
                        ? t("services.edit.creating")
                        : t("services.edit.editing")}
                </Header>
                <FormTable>
                    {/*Наименование услуги*/}
                    <CaptionCell>
                    ...
                    <ValueCell>
                        <Select
                            ...
                            options={options}
                            className={clsx(
                                "flex-1 w-full md:w-[450px] shadow-sm block mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 border-gray-300 rounded-md",
                                errors.service_id &&
                    ...
                    <CaptionCell>
                        <OptionItemNameWithError
                            error={errors.is_picked || errors.hourly_payment}
                        >
                        ...
                        <ul className="w-full">
                            ...
                            <CheckboxContainer>
                                <OptionItemCheckboxField
                                    ...
                                    label={t(
                                        "services.edit.paymentAmount.byAgreement"
                                    )}
                                    onChange={(e) => {
                            ...
                            <CheckboxContainer>
                                <OptionItemCheckboxField
                                    ...
                                    label={t(
                                        "services.edit.paymentAmount.hourlyPayment"
                                    )}
                                    onChange={(e) => {
                                ...
                                <div className="w-44 md:ms-3 my-2 items-center flex">
                                    ...
                                    />
                                    <div className="w-28 ms-4">
                                        ₪/{t("common:calendar.hour")}
                                    </div>
                                </div>
                            </CheckboxContainer>
                            <OptionItemErrorText
                                errorText={errors.hourly_payment}
                            />
                            ...
                            <CheckboxContainer>
                                <OptionItemCheckboxField
                                    ...
                                    label={t(
                                        "services.edit.paymentAmount.paymentByVolume"
                                    )}
                                    onChange={(e) => {
...
function CheckboxContainer({ children }) {
    return (
        <li className="flex-row md:flex w-full h-auto md:h-10 my-2 items-center">
            {children}
        </li>
    );
}
...
function SectionItem({ children, text, className }) {
    return (
        <section
            className={`${className} w-full px-3 py-5 h-auto rounded-md flex`}
        >
